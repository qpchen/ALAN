function ALANV2_Evaluate_PSNR_SSIM()

clear all; close all; clc

%% set path
degradation = 'BI'; % BI, BD
methods = {'alanv2_xt', 'alanv2_t', 'alanv2_xs'};
%methods = {'LatticeNet'};
...
record_results_txt = ['ALANV2_PSNR_SSIM_Results_', degradation,'.txt'];
...
record_means_results_txt = ['ALANV2_Means_PSNR_SSIM_Results_', degradation,'.txt'];
...
for idx_method = 1:num_method
    ...
    for idx_set = 1:num_set
        ...
        fprintf(means_results, '**********************\n');
        fprintf(means_results, 'Method_%d: %s; Set: %s\n', idx_method, methods{idx_method}, dataset{idx_set});
        fprintf('**********************\n');
        ...
        for scale = scale_all
            ...
            for idx_im = 1:length(filepaths)
                ...
                name_SR_tmp = strrep(name_HR, '_HR', '');
                name_SR = strrep(name_SR_tmp, '.', '_SR.');
