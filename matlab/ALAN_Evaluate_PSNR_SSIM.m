function ALAN_Evaluate_PSNR_SSIM()
...
record_results_txt = ['ALAN_PSNR_SSIM_Results_', degradation,'.txt'];
...
record_means_results_txt = ['ALAN_Means_PSNR_SSIM_Results_', degradation,'.txt'];
