function Evaluate_PSNR_SSIM_ERACNV9()

clear all; close all; clc

%% set path
degradation = 'BI'; % BI, BD
methods = {'v9fs', 'v9fblt', 'v9fbxt'};
%methods = {'LatticeNet'};
dataset = {'Set5', 'Set14', 'B100', 'Urban100', 'Manga109'};
ext = {'*.jpg', '*.png', '*.bmp'};
num_method = length(methods);
num_set = length(dataset);
record_results_txt = ['PSNR_SSIM_Results_', degradation,'_eracnv9.txt'];
...
record_means_results_txt = ['PSNR_SSIM_Means_Results_', degradation,'_sracnv9.txt'];
