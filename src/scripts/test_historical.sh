...
# ./scripts/test_historical.sh RAAN v1xs 4 48
#########################################
...
# python main.py --n_threads 1 --scale 2 --patch_size 96 --batch_size 32 --data_test Demo --dir_demo ../../dataset/historical/LR --n_colors 3 --res_connect 1acb3 --srarn_up_feat 24 --depths 2+2+2+2 --dims 24+24+24+24 --model SRARNV5 --save ../runtime_models/historical/v5xt_x2 --pre_train ../runtime_models/v5xt_x2.pt --test_only --load_inf --reset --runtime --times 10 --no_count --save_result
...
if [ $model = "FSRCNN" ]; then
  ...
  python main.py --n_threads 8 --n_GPUs 1 --scale $3 --patch_size $patch --batch_size 32 --data_test Demo --dir_demo ../../dataset/historical/LR --n_colors 3 --res_connect skip $dim_configs --upsampling Nearest --acb_norm v8old --model SRARNV8 --save ../runtime_models/historical/v8$2_x$3 --pre_train ../runtime_models/v8$2_x$3.pt --test_only --load_inf --reset --no_count --save_result 
# elif [ $model = "v5" ]; then
#   python main.py --n_threads 8 --n_GPUs 1 --scale $3 --patch_size $patch --batch_size 32 --data_test Demo --dir_demo ../../dataset/historical/LR --n_colors 3 --res_connect 1acb3 $dim_configs --model SRARNV5 --save ../runtime_models/historical/v5$2_x$3 --pre_train ../runtime_models/v5$2_x$3.pt --test_only --load_inf --reset --no_count --save_result 
elif [ $model = "v5" ]; then
  python main.py --n_threads 8 --n_GPUs 1 --scale $3 --patch_size $patch --batch_size 32 --data_test Demo --dir_demo ../../dataset/historical/LR --n_colors 3 --res_connect 1acb3 $dim_configs --model SRARNV5 --save ../runtime_models/historical/v5$2_x$3 --pre_train ../runtime_models/v5$2_x$3.pt --test_only --load_inf --reset --no_count --save_result 
elif [ $model = "v9" ]; then
  # ./scripts/train_srarn_v9.sh train 0 1 fbxt b 2 64 ms 1acb3 1acb3 batch befln nolr 2e-4 bicubic 0 0
  python main.py --n_threads 8 --n_GPUs 1 --scale $3 --patch_size $patch --batch_size 32 --data_test Demo --dir_demo ../../dataset/historical/LR --n_colors 3 --res_connect 1acb3 --deep_conv 1acb3 --acb_norm batch --norm_at before $dim_configs --upsampling Nearest --model SRARNV9 --save ../runtime_models/historical/v9$2_x$3 --pre_train ../runtime_models/v9$2_x$3.pt --test_only --load_inf --reset --no_count --save_result 
