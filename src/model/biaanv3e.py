...
class BIAANV3E(nn.Module):
    
    def __init__(self, args):
        super(BIAANV3E, self).__init__()
        
        in_nc  = 3
        out_nc = 3
        nf  = 40
        unf = 24 # version 3 & version 4:40; original:24
        nb  = 16
        scale = args.scale[0]
    ...
    def forward(self, x, y=None):
        if y is None:
            ...
            # return out, bout
            return out, bout, fea1, fea3, bfea1, bfea3
