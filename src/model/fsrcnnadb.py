...
class FSRCNNADB(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.feature_extraction = nn.Sequential(
            DiverseBranchBlock(num_channels, 56, 5, 1, 2, deploy=use_inf),
            nn.PReLU(56)
        )
        ...
        self.map = nn.Sequential(
            DiverseBranchBlock(12, 12, 3, 1, 1, deploy=use_inf),
            nn.PReLU(12),
            DiverseBranchBlock(12, 12, 3, 1, 1, deploy=use_inf),
            nn.PReLU(12),
            DiverseBranchBlock(12, 12, 3, 1, 1, deploy=use_inf),
        ...
        self.upconv1 = nn.Sequential(
            DiverseBranchBlock(56, 24, 3, 1, 1, deploy=use_inf),
            PA(24),
            nn.PReLU(24),
            DiverseBranchBlock(24, 24, 3, 1, 1, deploy=use_inf),
            nn.PReLU(24),
            DiverseBranchBlock(24, num_channels, 3, 1, 1, deploy=use_inf)
        )
