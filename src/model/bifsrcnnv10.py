...
def make_model(args, parent=False):
    return BIFSRCNNV10(args)


class BIFSRCNNV10(nn.Module):
    """
    Args:
    ...
    def __init__(self, args):
        super(BIFSRCNNV10, self).__init__()
    ...
    def forward(self, x, y=None):
        if y is None:
            ...
            bifea3 = self.bimap1(bifea2)
            bifea4 = self.bimap2(bifea3)
            bifea5 = self.bimap3(bifea4)
            bifea6 = self.bimap4(bifea5)
