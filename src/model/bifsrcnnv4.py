...
def make_model(args, parent=False):
    return BIFSRCNNV4(args)

class BIFSRCNNV4(nn.Module):
    """
    Args:
    ...
    def __init__(self, args):
        super(BIFSRCNNV4, self).__init__()
    ...
    def forward(self, x, y=None):
        if y is None:
            ...
            fea3 = self.map(fea2)
            fea4 = self.expand(fea3)
            out = self.deconv(fea4)
            ...
            return out, biout, fea1, fea2, fea3, fea4, bifea1, bifea2, bifea3, bifea4
