...
# python main.py --n_GPUs 1 --scale 2 --patch_size 128 --batch_size 32 --data_range 1-800 --data_test Set5 --loss '1*L1' --lr 2e-4 --optimizer ADAM --skip_threshold 1e6 --lr_class MultiStepLR --epochs 1000 --decay 500-800-900-950 --n_colors 3 --srarn_up_feat 60 --depths 6+6+6+6 --dims 60+60+60+60 --res_connect 1conv1 --model SwinIR --swinir_ablation --save SwinIR_t --reset
# python main.py --n_GPUs 1 --scale 2 --patch_size 128 --batch_size 32 --data_range 1-800 --data_test Set5 --loss '1*L1' --lr 2e-4 --optimizer ADAM --skip_threshold 1e6 --lr_class MultiStepLR --epochs 1000 --decay 500-800-900-950 --n_colors 3 --srarn_up_feat 60 --depths 6+6+6+6 --dims 60+60+60+60 --res_connect 1conv1 --model SwinIR--swinir_ablation --swinir_mlpdwc --save SwinIR_t --reset
...
if __name__ == '__main__':
    ...
    model = SwinIRA(upscale=2, img_size=(height, width),
